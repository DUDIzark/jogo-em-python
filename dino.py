...
pygame.display.set_caption('create DUDIzark - jogo do dino')
...
while True:
    ...
    if colidiu == True:
        if pontos % 100 == 0:
            pontos += 1
        game_over = exibe_mensagem('voce perdeu!', 40, (0,0,0))
        tela.blit(game_over, (LARGURA//2, ALTURA//2))
        restart = exibe_mensagem('aperte f para reiniciar', 20, (33,0,0))
